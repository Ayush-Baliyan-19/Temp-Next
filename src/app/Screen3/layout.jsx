    ...
    return (
        <>
            <div className="flex justify-between bg-primary  items-center w-screen overflow-x-hidden">
                {/* Left Component */}
                <div
                    className={`leftSection bg-[#9F8EFF] relative z-10 h-screen w-min p-6 flex justify-start items-start flex-col transition-all ${isLeftExpanded ? "transition-all" : "-translate-x-full transition-all"
                        }`}
                >
                    <div
                ...
                {/* Right Component */}
                <div
                    className={`rightSection bg-[#9F8EFF] h-screen p-6 flex flex-col justify-start items-start relative ${isRightExpanded
                            ? " transition-all"
